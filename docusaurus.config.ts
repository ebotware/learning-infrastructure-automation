...
const config: Config = {
  ...
  baseUrl: '/learning-infrastructure-automation/',
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/ebotware/learning-infrastructure-automation/tree/master/',
        },
        blog: false
        /*,
        blog: {
          ...
          // Remove this to remove the "edit this page" links.
          editUrl:
            'https://github.com/ebotware/docusaurus/tree/main/packages/create-docusaurus/templates/shared/',
